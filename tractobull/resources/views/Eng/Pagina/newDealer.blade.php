...
<head>
    ...
    <title>TRACTOBULL | NEW DEALLER</title>
</head>
<body>
 ...
 <section class="register-form">
	...
	<div class="container ">
		<div class="row justify-content-center mt-2 mb-5">
			<div class="col-md-8">
			<h2 class="gris-dark popins font-weight-normal text-center">Be part of our network of 
                <span class=" font-weight-bold">authorized Tractobull dealers </span>
                <span class="font-weight-bold azul-dark"> distributors.</span></h2>
			</div>
		</div>
			...
			<div class="pos-formulario col-md-9 ">	
				<form id="register_form" class="formulario-contacto " name="formID" role="form" method="post" enctype="multipart/form-data" action="#">
			        ...
			        <div class="col-12 p-0 rows-forms  d-sm-flex justify-content-center">        
				        ...
				        <div class="col-12 col-sm-6  sep-form-b">
			               <div class="col-12 col-sm-12 col-md-12 input-info ">
			               		<label class="label-text">Tax ID *</label>
					...
					<div class="col-12 p-0 rows-forms  d-sm-flex justify-content-center">        
				        <div class="col-12 col-sm-6  sep-form-b">
			               <div class="col-12 col-sm-12 col-md-12 input-info ">
			               		<label class="label-text">Start date of operations*</label>
					...
					<div class="col-12 p-0 rows-forms  d-sm-flex justify-content-center"> 
				        <div class="col-12 col-sm-4 sep-form-b">
			               <!-- Correo Electrónico -->
			               <div class="col-12 col-sm-12 col-md-12 input-info ">
			               		<label class="label-text">Website (opcional)</label>
				        ...
				        <div class="col-12 col-sm-8  sep-form-b">
			               <!-- Correo Electrónico -->
			               <div class="col-12 col-sm-12 col-md-12 input-info ">
			               		<label class="label-text">Primary activity*</label>
					...
					<div class="col-12 p-0 rows-forms  d-sm-flex justify-content-center"> 
				        <div class="col-12 col-sm-12 sep-form-b">
			               <!-- Correo Electrónico -->
			               <div class="col-12 col-sm-12 col-md-12 input-info ">
			               		<label class="label-text">Products you market*</label>
					...
					<div class="col-12 p-0 rows-forms d-sm-flex justify-content-center"> 
				        ...
				        <div class="col-12 col-sm-6  sep-form-b">
			               <!-- Correo Electrónico -->
			               <div class="col-12 col-sm-12 col-md-12 input-info ">
			               		<label class="label-text">Average annual sales* </label>
				        ...
				        <div class="col-12  session-rem sep-form-b">
				            ...
				            <a href="{{route('terminos')}}"> I have read and accept the Tractobull terms and conditions</a> 
				            <a href="{{route('aviso')}}"> and privacy policy</a> 
				        ...
				        <div class="col-12 d-flex justify-content-center mt-4 responsive-b-space">
				            <!-- Boton -->
				            <button  type="submit" id="register" class="btn btn-lg btn-primary ">SEND REQUEST  </button>  
				        </div> 
