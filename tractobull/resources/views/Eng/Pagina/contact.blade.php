...
<head>
    ...
    <title>TRACTOBULL | CONTACT US</title>
</head>
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 ">
            ...
            <h2 class="gris-dark popins text-contact font-weight-normal">If you have any questions or comments <span class="font-weight-bold">please do not hesitate to contact us</span></h2>
            <h4 class="font-weight-normal text-contact2">Our team of specialists will be ready to help you at all times.</h4>
        ...
        <div class="row mb-0 justify-content-between">
            ...
            <div class="col-12 col-sm-6 col-lg-4 item-ubicacion mb-2">
                <div class="d-flex justify-content-center w-100 lugar">
                    ...
                    <div class="col-7 p-0 pb-2 borde-azul"><h3 class="text-data pt-3">Email*</h3></div>
                </div>
            </div>
        </div>
...
<section class="about-info testimonios" id="services">
    <div class="container">
        <div class="row">
            <div class="col-md-6 ">
                <p class="mt-3">We'd like to hear from you</p>
                <h2 class="gris-dark popins text-contact font-weight-normal">Send us <span class="font-weight-bold">a message</span></h2>
                <span class="lineBlueContact"> </span>
            </div>
        </div>
                        ...
                        <div class="row" > 
                            <div class="col-12 col-md-4" >
                                <div class="form-group" >
                                    <input type="text" class="form-control placeholder-fix" name="name" placeholder="Full name*" required="required" >
                                    <label class="form-error error" for="name" ></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4" >
                                <div class="form-group" >
                                    <input type="text" class="form-control placeholder-fix" name="email" placeholder="Email*" required="required" >
                                    <label class="form-error error" for="email" ></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4" >
                                <div class="form-group" >
                                    <input type="text" class="form-control placeholder-fix" name="telephone" placeholder="Phone" >
                                    <label class="form-error error" for="telephone" ></label>
                                </div>
                            </div>
                            <div class="col-12" >
                                <div class="form-group" >
                                    <textarea type="text" name="message" class="form-control placeholder-fix" placeholder="Message" ></textarea>
                            ...
                            <div class="col-12 d-flex justify-content-center" >
                                <div class="col-12 col-md-2  p-0" >
                                    <input class="btn btn-primary rounded-0 btn-xs btn-block btn-send" type="submit" value="SEND " >
                                </div>
                            </div>
                        </div>
                    </form>
