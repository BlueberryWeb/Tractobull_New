...
<head>
    ...
    <title>TRACTOBULL | PRODUCTS</title>
</head>
<body>
      ...
      <header class="masthead about">
        ...
        <div class="container">
          <div class="intro-text">
            ...
            <div class="intro-heading text-uppercase poppins">PRODUCTS</div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 ">
              ...
              <h2 class="gris-dark popins font-weight-normal">Products manufactured <span class=" font-weight-bold">with the highest</span><span class="font-weight-bold azul-dark"> technology.</span></h2>
              <p class="">
                Our products are made in the factory with the highest technology machinery, since we have the latest generation Laser cutter and with our highly qualified staff we can produce quality parts.
              </p>
            </div>
          </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 text-center p-4">
              <h4 class="gris-dark text-uppercase">PRODUCTS</h4>
            </div>
          </div>
