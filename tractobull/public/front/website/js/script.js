...
$(document).on("ready",function(){
    ...
    var url_domain = "<?php echo $this->config->company->domain; ?>";         
      ...
      $("#mapa").gmaps({locations:[{'name': '','location': [20.654307,-103.338048,19],'thumb':'<?php echo $this->url->get("front/website/img/map_logo.png") ?>','id':'1',iconmarker:''} ],vm:".vermapa",icongm:"",z:18,difstl:true,showOnLoad:false});
      if(isset($locations)){ 
        $("#map").gmaps({
