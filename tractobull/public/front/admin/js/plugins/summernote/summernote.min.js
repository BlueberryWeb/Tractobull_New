...
!function (a) {
    ...
    var j = {
    ...
    }, k = String.fromCharCode(160), l = "\ufeff", m = function () {
        var b = function (b) {
        ...
        }, F = j.isMSIE && j.browserVersion < 11 ? "&nbsp;" : "<br>", G = function (a) {
            ...
            return e.length ? 1 === e.length ? la(b, d) : e.reduce(function (a, c) {
                return a === b.node && (a = la(b, d)), la({node: c, offset: a ? m.position(a) : G(c)}, d)
            }) : null
        }, na = function (a, b) {
            var c, e, f = b ? n : y, g = L(a.node, f), h = d.last(g) || a.node;
    ...
    a.summernote = a.summernote || {lang: {}}, a.fn.extend({
        summernote: function () {
    ...
    }, q = p.create('<div class="note-editor note-frame panel panel-default"/>'), r = p.create('<div class="note-toolbar panel-heading"/>'), s = p.create('<div class="note-editing-area"/>'), t = p.create('<textarea class="note-codable"/>'), u = p.create('<div class="note-editable panel-body" contentEditable="true"/>'), v = p.create(['<div class="note-statusbar">', '  <div class="note-resizebar">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', "  </div>", "</div>"].join("")), w = p.create('<div class="note-editor"/>'), x = p.create('<div class="note-editable" contentEditable="true"/>'), y = p.create('<div class="note-btn-group btn-group">'), z = p.create('<button type="button" class="note-btn btn btn-default btn-sm">', function (a, b) {
    ...
    var H, I = function () {
        ...
        var b = function (a, b) {
            ...
            for (c = 0; c < h.length; c++)if (!m.isText(h[c])) {
            ...
            var b = function (a, e) {
                var f, g;
                if (m.isText(a)) {
                    var h = m.listPrev(a, c.not(m.isText)), i = d.last(h).previousSibling;
            ...
            this.getPoints = function () {
                ...
                var c = m.ancestor(b, a), d = m.ancestor(h, a);
                ...
                var b = this.splitText(), c = b.nodes(null, {fullyContains: !0}), e = m.prevPointUntil(b.getStartPoint(), function (a) {
            ...
            this.isOnEditable = l(m.isEditable), this.isOnList = l(m.isList), this.isOnAnchor = l(m.isAnchor), this.isOnCell = l(m.isCell), this.isLeftEdgeOf = function (a) {
                ...
                var b = this.wrapBodyInlineWithPara().deleteContents(), c = m.splitPoint(b.getStartPoint(), m.isInline(a));
                ...
                return {s: {path: m.makeOffsetPath(a, b), offset: g}, e: {path: m.makeOffsetPath(a, h), offset: i}}
            }, this.paraBookmark = function (a) {
                return {
                    s: {path: d.tail(m.makeOffsetPath(d.head(a), b)), offset: g},
                    e: {path: d.tail(m.makeOffsetPath(d.last(a), h)), offset: i}
                }
        ...
        return {
            create: function (a, c, d, e) {
                if (arguments.length)2 === arguments.length && (d = a, e = c); else if (j.isW3CRangeSupport) {
                    ...
                    var i = document.selection.createRange(), k = i.duplicate();
                    k.collapse(!1);
                    var l = i;
                    l.collapse(!0);
                    var n = b(l, !0), o = b(k, !1);
                ...
                var b = a, c = 0, d = a, e = m.nodeLength(d);
                ...
                var c = m.fromOffsetPath(a, b.s.path), d = b.s.offset, e = m.fromOffsetPath(a, b.e.path), g = b.e.offset;
                return new f(c, d, e, g)
            }, createFromParaBookmark: function (a, b) {
                var c = a.s.offset, e = a.e.offset, g = m.fromOffsetPath(d.head(b), a.s.path), h = m.fromOffsetPath(d.last(b), a.e.path);
        ...
        var b = [], c = -1, d = a[0], e = function () {
            var b = J.create(), c = {s: {path: [], offset: 0}, e: {path: [], offset: 0}};
        ...
        this.fromNode = function (a) {
            ...
            a.each(b.nodes(m.isPara, {includeAncestor: !0}), function (b, d) {
                a(d).css(c)
            })
            ...
            var i = m.makePredByNodeName(f), j = b.nodes(m.isText, {fullyContains: !0}).map(function (a) {
            ...
            if (g) {
                ...
                return j.map(function (b) {
                    var c = m.withClosestSiblings(b, i), e = d.head(c), f = d.tail(c);
            ...
            var c = a(m.isElement(b.sc) ? b.sc : b.sc.parentNode), d = this.fromNode(c);
            try {
                d = a.extend(d, {
        ...
        this.insertOrderedList = function () {
            ...
            var b = this, e = J.create().wrapBodyInlineWithPara(), f = e.nodes(m.isPara, {includeAncestor: !0}), g = d.clusterBy(f, c.peq2("parentNode"));
            ...
            var e = this, f = J.create().wrapBodyInlineWithPara(), g = f.nodes(m.isPara, {includeAncestor: !0}), h = f.paraBookmark(g), i = d.clusterBy(g, c.peq2("parentNode"));
            if (d.find(g, m.isPurePara)) {
                ...
                var k = f.nodes(m.isList, {includeAncestor: !0}).filter(function (c) {
            ...
            var c = d.head(a), e = d.last(a), f = m.isList(c.previousSibling) && c.previousSibling, g = m.isList(e.nextSibling) && e.nextSibling, h = f || m.insertAfter(m.create(b || "UL"), e);
            ...
            return a.each(b, function (b, f) {
                var g = d.head(f), h = d.last(f), i = c ? m.lastAncestor(g, m.isList) : g.parentNode, j = i.childNodes.length > 1 ? m.splitTree(i, {
                    node: h.parentNode,
                    offset: m.position(h) + 1
                }, {isSkipPaddingBlankHTML: !0}) : null, k = m.splitTree(i, {
                    node: g.parentNode,
                    offset: m.position(g)
        ...
        this.insertTab = function (a, b, c) {
            ...
            if (f) {
                ...
                if (m.isEmpty(f) && m.isPara(f) && m.isBlockquote(f.parentNode))m.insertAfter(f, f.parentNode), e = f; else {
        ...
        this.tab = function (a, b) {
            var c = m.ancestor(a.commonAncestor(), m.isCell), e = m.ancestor(c, m.isTable), f = m.listDescendant(e, m.isCell), g = d[b ? "prev" : "next"](f, c);
    ...
    }, Q = "bogus", R = function (b) {
        var c = this, e = b.layoutInfo.note, f = b.layoutInfo.editor, g = b.layoutInfo.editable, h = b.options, i = h.langInfo, k = new M, l = new P, n = new O, o = new N, p = new L(g);
        this.initialize = function () {
            ...
            var c = h.keyMap[j.isMac ? "mac" : "pc"], d = [];
        ...
        this.tab = function () {
            ...
            return K.createImage(a, c).then(function (a) {
                q(), "function" == typeof c ? c(a) : ("string" == typeof c && a.attr("data-filename", c), a.css("width", Math.min(g.width(), a.width()))), a.show(), J.create().insertNode(a[0]), J.createFromNodeAfter(a[0]).select(), r()
            }).fail(function () {
        ...
        this.fontSize = function (b) {
            ...
            var c = J.create();
            if (c && c.isCollapsed()) {
                var e = k.styleNodes(c), f = d.head(e);
                a(e).css({"font-size": b + "px"}), f && !m.nodeLength(f) && (f.innerHTML = m.ZERO_WIDTH_NBSP_CHAR, J.createFromNodeAfter(f.firstChild).select(), g.data(Q, f))
            } else q(), a(k.styleNodes(c)).css({"font-size": b + "px"}), r()
        }, this.insertHorizontalRule = this.wrapCommand(function () {
            var b = J.create(), c = b.insertNode(a("<HR/>")[0]);
            ...
            var a = g.data(Q);
            if (a) {
                var b = d.find(d.from(a.childNodes), m.isText), c = b.nodeValue.indexOf(m.ZERO_WIDTH_NBSP_CHAR);
                -1 !== c && b.deleteData(c, 1), m.isEmpty(a) && m.remove(a), g.removeData(Q)
            }
        }, this.lineHeight = this.wrapCommand(function (a) {
            k.stylePara(J.create(), {lineHeight: a})
            ...
            if (i) {
                ...
                j.push(l)
            } else j = k.styleNodes(g, {nodeName: "A", expandClosestSibling: !0, onlyPartialContains: !0});
            a.each(j, function (b, d) {
                a(d).attr("href", c), f ? a(d).attr("target", "_blank") : a(d).removeAttr("target")
            });
            var m = J.createFromNodeBefore(d.head(j)), n = m.getStartPoint(), o = J.createFromNodeAfter(d.last(j)), p = o.getEndPoint();
            J.create(n.node, n.offset, p.node, p.offset).select()
        }), this.getLinkInfo = function () {
            this.focus();
            var b = J.create().expand(m.isAnchor), c = a(d.head(b.nodes(m.isAnchor)));
            return {
                range: b,
                text: b.toString(),
            ...
            var b = a.split("x"), c = J.create().deleteContents();
    ...
    var U = function (a) {
        ...
        this.sync = function () {
            ...
            var g = m.value(d, e.prettifyHtml) || m.emptyPara, h = c.html() !== g;
        ...
        this.toggle = function () {
            ...
            }).trigger("resize"), h.css("overflow", "hidden")) : (g.off("resize"), a({h: e.data("orgHeight")}), h.css("overflow", "visible")), b.invoke("toolbar.updateFullscreen", i)
        }
    }, Y = function (b) {
        ...
        this.events = {
            ...
            var d = m.isImg(c), e = this.$handle.find(".note-control-selection");
        ...
        var e = this, f = a.summernote.ui, g = b.layoutInfo.toolbar, h = b.options, i = h.langInfo, k = c.invertObject(h.keyMap[j.isMac ? "mac" : "pc"]), l = this.representShortcut = function (a) {
            var b = k[a];
        ...
        this.initialize = function () {
                ...
                return f.buttonGroup({
                    ...
                    children: [f.button({
                        ...
                        callback: function (a) {
                            ...
                            b.css({"background-color": "yellow"}), a.data("value", {backColor: "yellow"})
                        }
                    }), f.button({
                        className: "dropdown-toggle",
                        ...
                        click: function (c) {
                            ...
                            if (e && f) {
                                var g = "backColor" === e ? "background-color" : "color", h = d.closest(".note-color").find(".note-recent-color"), i = d.closest(".note-color").find(".note-current-color-button"), j = i.data("value");
            ...
            b.memo("button.justifyLeft", c.invoke(g, "render")), b.memo("button.justifyCenter", c.invoke(k, "render")), b.memo("button.justifyRight", c.invoke(m, "render")), b.memo("button.justifyFull", c.invoke(n, "render")), b.memo("button.outdent", c.invoke(o, "render")), b.memo("button.indent", c.invoke(p, "render")), b.memo("button.paragraph", function () {
                return f.buttonGroup([f.button({
                    ...
                    children: [g, k, m, n]
                }), f.buttonGroup({className: "note-list", children: [o, p]})])]).render()
            ...
            b.memo("button.imageSize100", function () {
                ...
                return f.button({
                    contents: f.icon(h.icons.alignRight),
                    tooltip: i.image.floatRight, click: b.createInvokeHandler("editor.floatMe", "right")
                }).render()
        ...
        this.events = {
            ...
            if (c.isCollapsed() && c.isOnAnchor()) {
                var d = m.ancestor(c.sc, m.isAnchor), e = a(d).attr("href");
        ...
        this.createShortCutList = function () {
            ...
            var b = f.dialogsInBody ? a(document.body) : e, c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.7.3</a> · ', '<a href="//github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = d.dialog({
